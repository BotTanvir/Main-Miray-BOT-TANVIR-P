...
module.exports.run = async({api,event,args}) => {
  ...
  {body:`🌐—»𝐁𝐎𝐓 𝐎𝐖𝐍𝐄𝐑«—🌐\n❯ 𝐍𝐚𝐦𝐞: 𝐓𝐀𝐍𝐕𝐈𝐑 𝐀𝐇𝐌𝐄𝐃-🖤\n❯ 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤: https://www.facebook.com/vwobntm471\n❯ 𝐓𝐡𝐚𝐧𝐤𝐬 𝐟𝐨𝐫 𝐮𝐬𝐢𝐧𝐠 ${global.config.BOTNAME} 𝐁𝐎𝐓`,
    attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => 
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(encodeURI(`https://graph.facebook.com/61561619394932/picture?height=720&width=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`)).pipe(
